...
ログインすると、Workatoのワークスペースに入ります。ワークスペースは、作業とチームのコラボレーションを整理するためのものです。デフォルトのワークスペースを探索するか、新しいワークスペースを作成してプロジェクトを整理しましょう。
...
レシピを成功した実行やエラーのためにモニタリングします。レシピエディタで：
